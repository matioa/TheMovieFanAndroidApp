...
public class FavoritesFragment extends Fragment implements ListView.OnItemClickListener, Response.Listener<String>, Response.ErrorListener  {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        this.listView = (ListView) view.findViewById(R.id.favorites_list);
    ...
    private void getData() {
        for (int i = 0; i < likedMovies.length(); i++) {
            String endpoint = null;
            try {
                endpoint = String.format(GlobalConstants.MOVIE_BYID_ENDPOINT, likedMovies.getInt(i), GlobalConstants.HEADER_TMDB_API_KEY_NAME, GlobalConstants.HEADER_TMDB_API_KEY_VALUE);
            } catch (JSONException e) {
                e.printStackTrace();
            }
