...
public class LoginFragment extends Fragment implements View.OnClickListener, Response.Listener<String>, Response.ErrorListener {
    ...
    private final String SAVED_OBJECTID_KEY = "objectId";
    ...
    public void onResponse(String response) {
        ...
        try {
            ...
            String objId = responseAsJSON.getString(this.SAVED_OBJECTID_KEY);
            JSONArray liked = responseAsJSON.getJSONArray("liked");
            JSONArray watchlist = responseAsJSON.getJSONArray("watchlist");

            this.mainActivity.loginUser(username, token, objId);
